...
(function () {
  ...
  function buildPanel() {
    ...
    bFindRow.style.cssText += 'width:auto;flex:0 0 auto;margin-top:0;padding:7px 11px;white-space:nowrap;background:#fff;color:#374151;font-weight:800;border:1.5px solid ' + ACC_BD + ';';
    ...
    const moreToggle = el('button', 'background:none;border:none;color:#374151;font-size:10px;font-weight:800;cursor:pointer;padding:6px 0 0;font-family:inherit;text-decoration:underline;', 'по частям, если что-то поехало ▾');
